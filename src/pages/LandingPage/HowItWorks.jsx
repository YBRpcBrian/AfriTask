...
const steps = [
  {
    ...
    title: "Post Your Job",
    description:
      "Describe your task and what kind of expert you're looking for. It only takes a few minutes.",
    icon: SearchCheck,
  },
  {
    id: 2,
    ...
    description:
      "Receive proposals, chat with freelancers, and choose the best fit to start working instantly.",
    icon: Handshake,
  },
  {
    id: 3,
    title: "Pay Securely",
    description:
      "Use AfriTask’s escrow to pay only when the job is done. Fast, safe, and simple.",
    icon: BadgeCheck,
  },
];
...
const HowItWorks = () => {
  ...
  return (
    <section ref={ref} className="bg-white py-16 px-4 md:px-8 lg:px-20">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <motion.p
          ...
          className="text-gray-500 text-sm md:text-base mb-12 max-w-2xl mx-auto"
        >
